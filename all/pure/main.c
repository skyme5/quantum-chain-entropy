...
* @Last Modified time: 2017-03-09 16:38:12
* @Subject:
*/
...
int main() {
  ...
  gsl_eigen_symmv_sort (EigenValue_ham, EigenVector_ham, GSL_EIGEN_SORT_ABS_ASC); {
    ...
    for (i = 0; i < states; i++) {		// Eigenvalues of each state
      ...
      //   eigen_vector[j] = gsl_matrix_get(EigenVector, i, j);
      // }
      ...
      printf("\n====================================\n");
#endif
      // gsl_eigen_symmv(density_matrix, EigenValue_density,EigenVector_density, workspace_density);
      //{
